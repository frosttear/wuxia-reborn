...
const ILLUSTRATIONS = [
  ...
  {
    id: "jianhun-origin-seal",
    name: "九百年前·封印",
    prompt: `Solemn wuxia sacrifice scene in ancient open wilderness, deep night, nine hundred years in the past. ${CHAR.mysteriousElder} — but younger in bearing, the nine hundred years of waiting not yet in his eyes — stands alone with his back to the viewer, facing away from us toward the primordial sword-intent: a towering inhuman column of cold silver-white light filling the upper frame, ageless and vast, utterly still. He does not attack it. He does not retreat. He simply places himself between it and the world — both arms at his sides, spine straight, the posture of a man who has made his decision and finds it correct. In his right palm, visible from behind, the cracked jade piece (双鱼玉佩, twin fish pendant) has just begun to emit its first cold light as the sealing begins — the moment of no return. The world he is protecting stretches behind him: a dark ancient plain, the suggestion of distant mountains at the horizon, everything beneath the stars he will never count again. No other figure. No witness. Only him, that vast cold light before him, and the silence of something irreversible beginning. Wide cinematic landscape composition, shot from behind the figure, Chinese ink painting aesthetic, deep midnight black and cold silver-white sword-light, the single jade-glow at his palm the only warm point in the frame, atmosphere of vast quiet sacrifice — not heroic, not tragic, simply necessary, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
  ...
  // ── 王铁 / Wang Tie ──
  {
    id: "wang-tie-meet",
    name: "王铁 — 初遇",
    prompt: `Wuxia solitary scene inside a dimly lit town tavern at night. ${CHAR.wangTie} sits completely alone at a rough wooden table, an earthen wine jug and a single cup before him. He is not looking at anything in particular — the middle distance, or something inside himself. His broad weathered hands rest around the cup, unhurried. No one else at his table; other patrons are faint shadows in the background. The weight of a long road is in his posture — not sadness exactly, just the settled heaviness of a man who has outlived too many things. Warm amber lantern light, deep shadow everywhere else, the quiet of a man who prefers it that way. Wide cinematic composition, Chinese ink painting aesthetic, warm amber and deep shadow tones, solitary and quietly melancholy atmosphere, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
    id: "wang-tie-bond-1",
    name: "王铁 — 第一章",
    prompt: `Intimate wuxia scene inside a dimly lit town tavern, late evening. ${CHAR.wangTie} and ${CHAR.player} sit across from each other at a low wooden table, two cups between them. Wang Tie leans slightly forward, speaking — not performing, just remembering aloud: thirty years on the escort roads, companions dead and gone, the weight of a life reduced to a handful of stories worth telling. The player listens with quiet attention, not interrupting. Wang Tie's eyes are distant, fixed on something the player cannot see. The atmosphere is the first real thread of trust forming between two people — quiet, unhurried, the tavern empty around them. Warm amber lantern light, deep shadow beyond the table, simple wooden surroundings. Wide cinematic composition, Chinese ink painting aesthetic, warm amber and deep shadow tones, quietly intimate and understated atmosphere, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
    id: "wang-tie-bond-2",
    name: "王铁 — 第二章",
  ...
  {
    id: "su-qing-special-bond-5",
    name: "苏青 — 悬壶问道",
    prompt: `Wuxia scene of quiet surpassing by candlelight, late night. ${CHAR.suQing} sits alone at a low wooden desk, bent over the last page of a dense document — her brush moving in a slow deliberate stroke to complete the final character. Open medical case-files are spread across the desk and floor, her shifu's original records laid alongside her own pages of careful annotation, the two sets of handwriting visible side by side: his older and more hesitant, hers precise and final. The single candle has burned very low. In the background, her elderly white-haired master sits propped against the wall on a sleeping mat, awake, watching her back in silence — he has been watching for hours and she has not noticed. Her posture carries no triumph, only the absorbed stillness of someone finishing a thing that had to be finished. She rests her brush and presses one hand flat on the completed document — a quiet confirmation that it is real. The room is still except for the candle. Wide cinematic composition, Chinese ink painting aesthetic, deep night shadow with a single low candle illuminating her focused face and the two sets of documents, the master's faintly watching silhouette in the background barely lit, atmosphere of something being quietly completed — not taken, earned, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
  ...
  },
  {
    ...
    name: "凌雪 — 那一杯水",
    prompt: `Quiet introspective wuxia scene on a sunlit stone courtyard step, late afternoon golden light. ${CHAR.lingXue} sits alone on the lower step of a courtyard entrance, white robes settling around her, both hands resting open in her lap. An old unglazed clay teapot — small, rough-fired, the kind used for everyday tea — sits on the stone step directly beside her right knee, placed there when she sat down: she brought it herself. She is alone in the frame. Her gaze is downward and slightly away, the expression unguarded for the first time: not cold, not defensive — the look of someone sitting with a feeling they have finally decided to stop avoiding. In the upper corner of the frame, a faint translucent memory impression hovers — barely there, like a ghost caught in the afternoon light: a single hand extending a plain ceramic cup of water toward her, the gesture simple and unhurried, already dissolving at the edges. A few plum blossoms have drifted onto the courtyard stones from beyond the wall. The empty step beside her holds only light and shadow. Bright warm afternoon light falls soft and clear, luminous pale gold, no deep shadows. Single-figure composition, Chinese ink painting aesthetic, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
