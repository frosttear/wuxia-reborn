...
const ILLUSTRATIONS = [
  ...
  },
  {
    ...
    name: "李云舒 — 承重之剑",
    prompt: `Charged wuxia confrontation scene inside a dim stone hall, late afternoon light cutting in through high narrow windows. ${CHAR.liYunshu} stands facing a middle-aged Chinese villain — a hard-faced man in dark layered robes, jaw set, arms crossed, his expression carrying cold condescension rather than open hostility. He has just finished speaking — the space between them carries the weight of a moral trap. She has drawn her sword: her grip is calm, not tense, her expression carrying something sharper than anger — discernment. She is not reacting; she is deciding. Her bright peach-and-gold hanfu catches the narrow shafts of dusty light, the drawn blade catching a thin line of brightness. The villain registers her stance without alarm, as if he expected it; this is the gap between them — he never expected her to understand. Wide cinematic composition, Chinese ink painting aesthetic, cool stone-grey interior with narrow warm light shafts, a scene of moral clarity meeting moral contempt, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
  ...
  },
  {
    ...
    name: "燕赤行 — 后日谈·立碑",
    prompt: `Wuxia scene of final release at a mountain gate at dusk. ${CHAR.yanChixing} kneels alone before the name-side of a newly carved stone monument — thirty names chiselled in columns into the rough stone face, dense and deliberate, each stroke cut by hand; at the very end two spaces have been left blank, empty and intentional. The sect token is buried at the monument's base. For the first time, tears run silently down his scarred face. His hands rest flat on the stone, grounding himself in this moment. The sky behind him fades gold and deep violet, the mountain in long shadow. ${CHAR.player} stands a few paces back, leaving him this private grief. The viewer faces the name-carved face of the monument directly, so the columns of names fill the stone. Wide cinematic composition, Chinese ink painting aesthetic, fading gold dusk and deep shadow tones, cathartic and quietly triumphant atmosphere, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
