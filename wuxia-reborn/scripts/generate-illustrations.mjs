...
const ILLUSTRATIONS = [
  ...
  },
  {
    id: "designer-win",
    name: "九百年前·终结",
    prompt: `Transcendent wuxia climax scene set nine hundred years in the past. An ancient primordial sword spirit (剑魂·本源) — a colossal faceless humanoid entirely made of pure, ancient sword-intent light, far vaster and more overwhelming than its sealed form, its edges sharp enough to warp the air — has stopped mid-strike. From ${CHAR.player}'s chest radiate five intertwining streams of warm light, each a different colour, each the presence of someone he truly knew: a brash amber warmth, a bright clear gold, a deep still blue, a sharp cool silver, a quiet steady green. These streams of light have reached the ancient sword spirit, and for the first time in a thousand years something vast and purely inhuman has encountered something it cannot parse. The sword spirit's form trembles — not from damage, but from the presence of something entirely outside its experience. A sunrise is beginning behind them, thin gold light on an ancient mountain horizon, the first real dawn in nine hundred years. ${CHAR.player} stands at center, sword lowered, light flowing from him outward — this is not a victory of force. Wide cinematic landscape composition, Chinese ink painting aesthetic with five-colour warm streams of light against cold ancient silver-white, atmosphere of profound human connection overcoming something inhuman, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
    id: "designer-lose",
    name: "九百年前·败北",
    prompt: `Overwhelming wuxia defeat scene set nine hundred years in the past. ${CHAR.player} kneels on ancient ground, sword fallen, breathing in labored gasps. Above him towers the primordial sword spirit (剑魂·本源) in its original unsealed form — a colossal faceless being made of ancient, unbroken sword-intent light, vast and inhuman, its edges warping the air around it, filling the entire upper frame with cold silver-white radiance so intense it casts no shadow. There is no malice in it — it simply does not know how to understand what the player was trying to do. The protagonist's chest holds no answering light — the bonds were not enough, or not yet forged. An ancient mountain horizon behind them, grey and lightless, dawn not yet come. Wide cinematic composition, Chinese ink painting aesthetic with cold silver-white primordial light overwhelming a small kneeling figure, atmosphere of insufficient preparation confronting something immense and old, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  ...
  },
  {
    ...
    name: "李云舒 — 后日谈·她想见那个人",
    prompt: `Quiet wuxia evening scene indoors, warm amber lantern light. ${CHAR.liYunshu} stands still in the center of the room, one hand resting at her side, the other loosely at her sword hilt — not drawing, just grounded. Her expression is quiet and purposeful: not excited, not angry — she has just heard something and has already decided what she wants to do. ${CHAR.player} stands a step away facing her, having just delivered the news. Between them, a small oil lamp on a low wooden table casts the only light; the window beyond holds the last of dusk turning to dark. She looks like someone who has been carrying a half-formed question for a long time and has just felt it settle into the shape of a decision. Wide cinematic composition, Chinese ink painting aesthetic, warm amber lantern light against deep evening shadow, quiet resolved atmosphere, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
  ...
  },
  {
    ...
    name: "燕赤行 — 后日谈·传灯",
    prompt: `Forward-looking wuxia scene on a mountain path descending from the peak, last amber light of the day. ${CHAR.yanChixing} walks ahead down the winding mountain road — his posture looser than we have ever seen it, the habitual tension of a man with something unfinished finally gone. He has just stopped for a moment at the figure visible behind him: a lone young swordsman still sitting at the roadside, now turning to look after him with a different expression than before — something shifted. ${CHAR.player} walks a step behind 燕赤行. No sect banner, no obligation, no destination yet decided — just a man walking down a mountain who happened to say something useful to a stranger. The stone monument at the summit is behind them, out of frame. The path winds down into valley haze, mountain silhouettes receding into pale dusk gold on all sides. Wide cinematic composition, Chinese ink painting aesthetic, pale amber-gold dusk light descending a mountain road into cool deep valley shadow, quietly forward-moving atmosphere of someone who has just set something down and is walking lighter, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
  ...
  {
    id: "ling-xue-afterstory-memory",
    name: "凌雪 — 那一杯水",
    prompt: `Quiet reflective wuxia scene inside a small inn room at night. ${CHAR.lingXue} sits on a low wooden bench near a paper-screen window, sword resting across her knees mid-cleaning, a cloth in one hand — she has paused, not finished. Her gaze is turned inward, not at the window or the sword or anything in the room; she is remembering something. ${CHAR.player} sits nearby, slightly angled away, present but not interrupting. A single candle burns between them on a low table, its flame barely moving. The room is spare and dim. No action, no tension — only the weight of a memory surfacing slowly in a person who has rarely let herself have memories. Wide cinematic composition, Chinese ink painting aesthetic, deep indigo night with single warm candlelight casting soft amber across her pale robes and the blade, intimate and still atmosphere, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
  ...
  },
  {
    ...
    name: "神秘老者 — 长夜将晓",
    prompt: `Wuxia scene of renewal, hope, and dawn after nine hundred years. A simple paper-windowed room fills with warm gold-rose morning light — the first true dawn in centuries. An elderly white-haired Chinese sage (沈玄清) stands facing the paper window, posture naturally upright — the constrained supernatural stillness of the possessed man is gone; what remains is the simple dignity of an old swordmaster returned to himself, his hands open and unguarded at his sides, no jade piece at his waist. He faces the light with clear calm eyes: the expression of a man who has just set down something he carried so long he had forgotten what he was carrying. In the open doorway behind him, a young woman in plain medicinal robes (沈微尘) steps forward into the room — dawn light glowing behind her like a halo, her expression warm and full of quiet certainty, her lips parting to say one word. A single burned-out candle stands on the low table, its work done. Outside the paper window: pale gold sky, soft rose clouds, mountains emerging from night into morning. Wide cinematic composition, Chinese ink painting aesthetic, the room flooded with warm gold-rose dawn light from both the window and the doorway, profound gentle warmth of a very long night finally ending and a new day fully beginning, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
];
