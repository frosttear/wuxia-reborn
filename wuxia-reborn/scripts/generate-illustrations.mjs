...
const ILLUSTRATIONS = [
  ...
  },
  {
    ...
    name: "凌雪 — 那一杯水",
    prompt: `Quiet wuxia scene on a sunlit stone courtyard step, late afternoon golden light. ${CHAR.lingXue} sits on the lower step of a courtyard entrance, white robes settling around her, both hands resting open in her lap. An old unglazed clay teapot — small, rough-fired, the kind used for everyday tea — sits on the stone step directly beside her right knee, placed there when she sat down: she brought it herself. She is not looking at ${CHAR.player} and not looking at the teapot — her gaze is downward and slightly away, the expression unguarded for the first time: not cold, not defensive — the look of someone sitting with a feeling they have finally decided to stop avoiding. In the upper corner of the frame, a faint translucent impression hovers — barely there, like a ghost caught in the afternoon light: a single hand extending a plain ceramic cup of water, the gesture simple and unhurried, already dissolving at the edges. ${CHAR.player} sits beside her on the same step at a comfortable distance, also looking forward, not at her — present without pressure. A few plum blossoms have drifted onto the courtyard stones from beyond the wall. Bright warm afternoon light falls soft and clear across both figures, luminous pale gold, no deep shadows. Wide cinematic composition, Chinese ink painting aesthetic, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
