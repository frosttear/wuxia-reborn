...
const ILLUSTRATIONS = [
  ...
  },
  {
    id: "designer-win",
    name: "轮回设计者 — 胜利（真结局）",
    prompt: `Epic wuxia liberation scene. ${CHAR.mysteriousElder} — in his true form — stands with eyes closed as a vast dark force pours out of his body and dissolves upward into light, nine hundred years of corruption finally departing; the cracked jade piece has fallen from his hand and shatters on the ground, its cold structural light fading into dust. He does not collapse in defeat but stands lighter, freed, as if a great invisible weight has lifted from his shoulders. The space around him, which had bent subtly and wrongly, slowly rights itself — light returning to its natural directions. ${CHAR.player} stands before him, sword lowered, surrounded by dissolving ghost-silhouettes of past lives unraveling like smoke. The old sage's ancient eyes open — deep exhaustion, but no malice, only release. Dawn light breaks through clouds for the first honest sunrise in nine hundred years. Wide cinematic landscape composition, Chinese ink painting aesthetic with pale gold and twilight blue tones, transcendent yet melancholic atmosphere, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
    id: "designer-lose",
    name: "轮回设计者 — 失败（真结局）",
    prompt: `Overwhelming wuxia scene. ${CHAR.player} kneels on the ground, battered and exhausted. ${CHAR.mysteriousElder} stands above him in his true form — the cracked jade piece removed from his waist and held out in one extended hand, pouring cold pale structural light in every direction; his aged hands carry something vast and architectural, the accumulated pressure of nine hundred years of deliberate design bearing down; the world around him is subtly wrong, light falling in directions it should not, space bending at the point of his power. His posture is unchanged — that sword-at-rest stillness — and his expression is sorrowful and resolute, not triumphant. Faint ghost-traces of failed timelines shimmer behind him like a gallery of echoes. Wide cinematic composition, Chinese ink painting aesthetic with cold jade-white and deep shadow tones, suffocating inevitability atmosphere, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  ...
  },
  {
    ...
    name: "燕赤行 — 后日谈·归山",
    prompt: `Wuxia pilgrimage scene in the overgrown ruins of the Hanlight Sect's mountain stronghold. ${CHAR.yanChixing} and ${CHAR.player} stand before a crumbling stone wall half-covered in vines and moss, where dozens of names have been carved into the rock — the full roster of the sect. Yan Chixing's hand has stopped, still and grave, on two names among the rest; unlike the others, these two names belong to people still alive in this world. His expression carries something more complex than grief — part recognition, part weight he cannot name. The ruins stretch behind them into dark forest, the mountain reclaiming everything. Grey overcast sky, wind through broken stone. Wide cinematic composition, Chinese ink painting aesthetic, cold grey ruin and deep shadow tones, solemn memorial atmosphere, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
    id: "yan-chixing-afterstory-ending",
    name: "燕赤行 — 后日谈·立碑",
    prompt: `Wuxia scene of final release at a mountain gate at dusk. ${CHAR.yanChixing} kneels alone before a newly carved stone monument at the Hanlight Sect's mountain entrance — thirty names of the fallen inscribed in clean strokes on its back face, with two spaces deliberately left blank at the end; the living do not belong here. The sect token is buried at the monument's base. For the first time, tears run silently down his scarred face. His hands rest flat on the stone, grounding himself in this moment. The sky behind the gate fades gold and deep violet, the mountain in long shadow. ${CHAR.player} stands a few paces back, leaving him this private grief. Wide cinematic composition, Chinese ink painting aesthetic, fading gold dusk and deep shadow tones, cathartic and quietly triumphant atmosphere, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
