...
const ILLUSTRATIONS = [
  ...
  },
  {
    id: "designer-win",
    name: "轮回设计者 — 胜利（真结局）",
    prompt: `Epic wuxia culmination scene. ${CHAR.mysteriousElder} — in his true form, the cracked jade piece removed from his waist and now fallen from his hand, pouring its last cold pale light in fading rays across the ground as it shatters into luminescent dust — collapses to the earth; the space around him, which bent subtly and wrongly while he held power, is slowly righting itself, light returning to its natural directions. ${CHAR.player} stands before him, sword at rest, surrounded by the dissolving remnants of a nine-hundred-year cycle — translucent ghost-silhouettes of past lives unraveling like smoke in the air above. The old sage's ancient eyes hold no malice in defeat, only deep exhaustion and something like release. Dawn light breaks through clouds above for the first honest sunrise in nine hundred years. Wide cinematic landscape composition, Chinese ink painting aesthetic with pale gold and twilight blue tones, transcendent yet melancholic atmosphere, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
    id: "designer-lose",
    name: "轮回设计者 — 失败（真结局）",
