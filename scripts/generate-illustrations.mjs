...
const ILLUSTRATIONS = [
  ...
  },
  {
    ...
    name: "神秘老者 — 第三章",
    prompt: `Wuxia revelation scene in an isolated stone pavilion perched above misty mountain valleys. A very old white-haired sage (沈玄清) sits across from ${CHAR.player}, his aged face carrying the quiet gravity of a secret finally released. He extends one weathered hand palm-upward — showing a star-shaped burn scar, the mark of what he truly is. His expression is solemn and unguarded for the first time, the mask of the vague wandering elder finally dropped. Pale mountain mist below, the pavilion above the clouds, a vast and silent world. Wide cinematic composition, Chinese ink painting aesthetic, pale grey mist and cold mountain light tones, solemn revelation atmosphere, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
    id: "mysterious-elder-bond-4",
    name: "神秘老者 — 第四章",
    prompt: `Tense and sorrowful wuxia scene in a walled garden courtyard, surrounded. A very old white-haired sage sits calmly at a stone table, teacup in hand, as black-robed Heaven Demon assassins close in from three sides — he does not move, does not resist, as if he has already accepted something. ${CHAR.player} stands sword-drawn between the elder and the attackers, buying time. The elder speaks through it all, his voice low and grief-laden: recounting a student who was not born evil, but was broken, and whom he could not save. Stone garden walls, late afternoon light slanting through, the stillness of a man who has carried this grief for decades. Wide cinematic composition, Chinese ink painting aesthetic, cold grey stone and harsh amber shadow tones, tense and sorrowful atmosphere, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
    id: "mysterious-elder-afterstory",
    name: "神秘老者 — 后日谈·铜簪",
    prompt: `Intimate wuxia scene by evening candlelight. A very old white-haired sage holds a small copper hairpin in his trembling aged hands — his disappeared daughter's keepsake, carried for twenty years. With great care he lowers it into ${CHAR.player}'s cupped hands, his fingers barely releasing it, as if letting go of the one tangible thread connecting him to her. His expression carries decades of grief and a faint, fragile hope. ${CHAR.player} holds the hairpin, understanding the weight of what is being asked. A single candle on the table, deep shadow, a profoundly small and precious object at the center of the frame. Wide cinematic composition, Chinese ink painting aesthetic, single candlelight gold and deep shadow tones, quietly heartbreaking and hopeful atmosphere, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
  {
    id: "mysterious-elder-afterstory-ending",
    name: "神秘老者 — 后日谈·重逢",
    prompt: `Deeply moving wuxia reunion scene in a moonlit garden pavilion. A very old white-haired sage (沈玄清) kneels before his daughter (沈微尘) — a quiet woman in plain robes with her father's stillness. With trembling hands he carefully pins a small copper hairpin back into her hair — the same pin he has carried for twenty years. Neither speaks. Her eyes are closed; his head is bowed in the act of this small gesture that undoes twenty years. ${CHAR.player} stands to the side in the shadows, a silent witness. Pale silver moonlight on the pavilion stones, a single plum tree in early bloom nearby. Wide cinematic composition, Chinese ink painting aesthetic, cold silver moonlight and deep garden shadow tones, profoundly moving and silent atmosphere, anime-inspired semi-realistic art, high quality detailed scene.`,
  },
];
