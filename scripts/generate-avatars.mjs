...
const CHARACTERS = [
  ...
  },
  {
    ...
    prompt: "A very old Chinese sage (沈玄清) in ancient wuxia setting, extreme age but with an unnaturally straight spine — the compact upright posture of a sword at rest, no wasted curve despite his years, suggesting a lifetime of sword discipline rather than cultivation. Pure white hair worn simply, long white beard. Plain unadorned pale grey-white martial robes, no ornament except a small cracked jade piece fastened at his waist sash that emits a faint cold pale luminescence with no natural light source. His right hand is visible at his side — the index and middle fingers bear deep blade-calluses from ten thousand sword strokes, not the palm-calluses of inner force cultivation. His expression is entirely calm and utterly unreadable, eyes carrying the quality of a man watching events he has already seen conclude. Standing against a cold grey misty mountain backdrop, pale silver light. Chinese ink painting aesthetic with cool grey-white and faint cold jade-pale tones, portrait composition from waist up, anime-inspired semi-realistic style, detailed face, high quality"
  },
  {
    id: "yan-chixing",
