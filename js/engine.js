    ...
    triggerTrueVictory() {
        ...
        const epilogues = [
            [
                ...
                { text: '里面有个年轻人，正在练刀。架子、步法、收势——你认出来了，那是王铁的路数。', cls: 'system' },
                { text: '他没有开宗立派，没有留下名号，但他的刀法，还有人在练。', cls: 'win' },
                { text: '你没有进去，转身继续走。有些事，知道就够了。', cls: 'system' },
            ],
            [
                { text: '【李云舒】', cls: 'system' },
                { text: '李云舒把那封旧信折好，重新收进怀里。关于她母亲的事，你已经一一告诉她了。', cls: 'system' },
                { text: '沉默了很久之后，她抬起头：「所以，接下来去哪？」', cls: 'result' },
                { text: '「还没想好。」你说。', cls: 'system' },
                { text: '「那就一起想。」她站起来，拍了拍衣袖，「反正现在，你哪儿都不用去了——时间是你自己的了。」', cls: 'win' },
            ],
            [
                { text: '【神秘老者 · 沈玄清】', cls: 'system' },
                { text: '轮回锁断的那一刻，盘踞在他识海里九百年的东西，随之散了。', cls: 'system' },
                { text: '你在一间简陋的客房里找到他——不是那个掌控轮回的人，只是一个衰老的、疲惫的老者。', cls: 'system' },
                { text: '他没有辩解。只是看着你，开口说：「老夫欠你的，比你以为的多得多。」', cls: 'result' },
                { text: '你没有答话。这件事的是非，你已经在走完的那条路上想清楚了。', cls: 'system' },
                { text: '沈微尘后来的，是沈微尘找来的——她听见门开的声音，在门口停了很久，才轻声叫了一声：「爹。」', cls: 'system' },
                { text: '那一声，让他眼里有什么东西重新回来了。', cls: 'win' },
            ],
            [
                { text: '【燕赤行】', cls: 'system' },
                { text: '含光山上的碑立好之后，燕赤行就下山了，此后再没回去过。', cls: 'system' },
                { text: '他又回到了那种来去无踪的日子——只不过这次，身上没有什么放不下的了。', cls: 'system' },
                { text: '「想好去哪了吗？」他有一天忽然问你，语气跟在问天气差不多。', cls: 'result' },
                { text: '「还没有。」', cls: 'system' },
                { text: '「那就慢慢走。」他把刀往背上一负，「江湖这么大，总有地方可以去的。」', cls: 'result' },
            ],
            [
                { text: '【凌雪】', cls: 'system' },
                { text: '凌雪和白渊的事了了之后，她在镇上又住了几天，然后收拾包袱，准备上路。', cls: 'system' },
                { text: '你去送她，她只是摆了摆手：「不用送，路认得。」', cls: 'system' },
                { text: '走出几步，她回头：「你的事，办完了？」', cls: 'result' },
                { text: '「办完了。」', cls: 'system' },
                { text: '「那就好。」她转过身，没再回头，「各走各的路——有缘再见。」', cls: 'win' },
            ],
            [
                { text: '【苏青】', cls: 'system' },
                { text: '济世堂的生意比苏青预想的忙。你去找她的时候，她正在给人包伤口，头都没抬。', cls: 'system' },
                { text: '「等一下。」', cls: 'result' },
                { text: '等那人走了，她才过来，不由分说地把了把脉，皱眉看了看，点头：「稳了，比以前好多了。」', cls: 'system' },
                { text: '「你这是……」你刚开口，她已经转身拿下一个病人的药方，「以后不用再重来了，好好过。」', cls: 'result' },
                { text: '她说得很轻，像是叮嘱，也像是道别。门口还有人在等，她一转身就进去了。', cls: 'system' },
            ],
        ];
