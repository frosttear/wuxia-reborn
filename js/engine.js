    ...
    triggerTrueVictory() {
        ...
        const epilogues = [
            ...
            [
                ...
                { text: '你去找他的时候，他正和沈微尘在院里对弈，棋局到了中盘，两人都在沉思。', cls: 'system' },
                { text: '他见你落座，抬了一下眼，没有说话。你也没有问那个你曾以为必须问的问题。', cls: 'system' },
                { text: '半局棋看完，他才开口：「走完了？」', cls: 'result' },
                { text: '「走完了。」', cls: 'system' },
                { text: '他点了点头，落下一子。沈微尘抬起头看了父亲一眼，没有说话。', cls: 'system' },
                { text: '你起身告辞的时候，他身上那种常年悬着的东西，好像轻了一些。', cls: 'win' },
            ],
            [
                { text: '【燕赤行】', cls: 'system' },
