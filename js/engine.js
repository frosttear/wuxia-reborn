...
const Engine = {
    ...
    async triggerTrueVictory() {
        ...
        const epilogues = [
            ...
            },
            {
                ...
                lines: [
                    ...
                    { text: '后来，你们走到了一处崖边。不知道是谁先走到那里去的，也不知道是谁先停下来的。风从下面往上吹，把她的发丝卷起来。', cls: 'epilogue' },
                    { text: '远处是连绵的山，山里是云，云里是光——那种你活过了无数世都没有抬头认真看过的光。', cls: 'epilogue' },
                    { text: '她忽然伸手握住了你的手，也没有解释，就那么握着，看着远处。', cls: 'epilogue-win' },
                    { text: '「以前我也不常看这种光，」她说，「老是想着还有什么事没做完，总是低着头走路。你知道我这人，心里装的事多，闲下来反而不习惯。」', cls: 'epilogue-dialogue' },
                    { text: '「那现在呢？」你问。', cls: 'epilogue-dialogue' },
                    { text: '「现在——」她停顿了一下，侧过脸来认真看了你一眼，「现在不一样了。有你在旁边，我就突然想多抬头看看了。不知道为什么，就是这样。」', cls: 'epilogue-dialogue' },
                    { text: '你没有说话，只是把手握紧了一点。', cls: 'epilogue' },
                    { text: '她轻轻笑了一声，也没有再说什么，就那么并肩站着，看着远处的山和光。', cls: 'epilogue-win' },
                    { text: '就这样，两个人，一片山，一片光，把所有来日都装了进去。', cls: 'epilogue-win' },
                ],
            },
        ];
        ...
        const closingLines = [
            ...
            { text: '故事，至此完结。', cls: 'epilogue-ending' },
        ];
